...
bool Commands::execute_command(Client *client, std::string cmd, std::string args)
{
...
void Commands::pass_command(Client *client, std::string args)
{
	if (args.size() < 2)
...
void Commands::pong_command(Client *client, std::vector<std::string> args)
{
	(void) args;
